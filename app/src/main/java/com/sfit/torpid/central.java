...
public class central extends AppCompatActivity {
    ...
    CharSequence[] station_s = {"Mumbai CST", "Masjid bunder", "Sandhurst Road", "Byculla", "Chinchpokli", "Currey Road", "Parel", "Dadar", "Matunga", "Sion", "Kurla", "Vidyavihar", "Ghatkopar", "Vikroli", "Kanjurmarg", "Bhandup", "Nahur", "Mulund", "Thane", "Kalwa", "Mumbra", "Diva", "Dombivali", "Thakurli", "Kalyan", "Shahad", "Ambivili", "Titwala", "Khadvali", "Vashind", "Asangaon", "Atgaon", "Khardi", "Kasara"};
    CharSequence[] station_d = {"Mumbai CST", "Masjid bunder", "Sandhurst Road", "Byculla", "Chinchpokli", "Currey Road", "Parel", "Dadar", "Matunga", "Sion", "Kurla", "Vidyavihar", "Ghatkopar", "Vikroli", "Kanjurmarg", "Bhandup", "Nahur", "Mulund", "Thane", "Kalwa", "Mumbra", "Diva", "Dombivali", "Thakurli", "Kalyan", "Shahad", "Ambivili", "Titwala", "Khadvali", "Vashind", "Asangaon", "Atgaon", "Khardi", "Kasara"};
    String source1,dest1;
    String tick1="1";
    //String abc;
    //int p1,p2,p3 = 1; (previously saved vars)
    int flag1=0, flag2=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AutoCompleteTextView source = (AutoCompleteTextView) findViewById(R.id.cent_sp1);
        final AutoCompleteTextView destination = (AutoCompleteTextView) findViewById(R.id.cent_sp2);
        ...
        NumberPicker np = (NumberPicker) findViewById(R.id.cent_sp3);
        np.setMinValue(1);
        np.setMaxValue(6);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    Intent s = new Intent(central.this, QRCode.class);
                    Intent in = getIntent();
